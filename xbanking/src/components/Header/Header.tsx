...
export default function Header({ onDashboardClick }: HeaderProps) {
  ...
  return (
    <header className={`fixed lg:relative top-0 left-0 right-0 bg-white z-50 transition-all duration-300 py-9 xl:py-6 lg:py-4 ${isScrolled ? 'shadow-sm lg:shadow-none' : ''}`}>
          ...
          <div className="flex justify-between items-center gap-20 xl:gap-10 lg:gap-6">
            <a href="#" className="w-fit xl:w-40 lg:w-32">
              <div className="flex items-center">
                ...
                {/* <span className="ml-2 text-xl font-bold">xbanking</span> */}
              </div>
            </a>
            ...
            <ul className="flex gap-5 items-center md:flex-col">
              <li className="md:w-full flex">
                <button
                  ...
                  className="min-w-32 w-fit py-[10px] px-6 bg-purple rounded-lg 
              ...
              <li className="md:w-full flex">
                <a
                  href=""
                  className="min-w-32 w-fit py-[10px] px-6 bg-transparent rounded-lg 
              ...
              <li className="flex items-center gap-5 md:w-full">
                <a href="" className="flex items-center gap-2 md:w-full">
                  ...
                  <div className="bg-lite-grey rounded-2xl py-[10px] px-4 font-weight-semibold text-base text-grey">
                    0x3214...4df54gdfg
                  </div>
                </a>
